...
class SummaryContract extends Component {
  ...
  raiseDispute = () =>
    this.props.raiseDisputeContract(
      this.props.contract,
      ...
      <div className={`SummaryContract-container`}>
        ...
        <div className="content">
          ...
          <div className="summary">
            ...
            <br />
            Party A Fee Paid: {contract.partyAFeeEther}
            <br />
            Party B Fee Paid: {contract.partyBFeeEther}
            <br />
            Status: {STATUS_TO_STATE[contract.status] || '?'}
            <br />
          </div>
          ...
          {contract.evidences !== undefined &&
            contract.evidences.length > 0 && <h2>Evidences</h2>}
          <ul>
            {contract.evidences !== undefined &&
              contract.evidences.map(evidence => (
                <li key={evidence._id}>{`${evidence.name}: ${
